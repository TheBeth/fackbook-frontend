function PostAction({numComment, toggleShowComment, toggleShowForm}) { // get value nummComment from PostFooter
    return (
        <>
            <div className="d-flex justify-content-between align-items-center">
                <div className="d-flex">
                    <img
                        ...
                        alt="user"
                    />
                    <small className="ms-2 text-muted">You and 1.2m others</small>
                </div>
            ...
            <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="text-center flex-grow-1" role="button" onClick={toggleShowForm} >
